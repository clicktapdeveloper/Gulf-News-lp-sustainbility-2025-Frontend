...
const BecomeEventSponsor = () => {
    return <div id="be-a-sponsor" className="bg-[var(--white-color)] py-mobile-padding sm:py-tablet-padding lg:py-desktop-padding px-standard-mobile-padding sm:px-standard-tablet-padding lg:px-standard-desktop-padding 2xl:px-standard-xl-padding">
