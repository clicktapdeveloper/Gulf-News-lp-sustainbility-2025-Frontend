...
const Hero = () => {
    ...
    return <div className="relative flex flex-col lg:flex-row h-[620px] sm:h-[600px] overflow-hidden">
        ...
        <img src="/logo/SEA.svg" alt="Hero" className="absolute top-96 lg:top-10 right-[100px] lg:right-[500px] h-[200px] lg:h-[350px]" />
    </div>
}
